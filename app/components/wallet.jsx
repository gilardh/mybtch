          ...
          <FormGroup row>            
            <Col>
              ...
              <FormText color="muted">
                <span className="import4">For Windows, it should be in</span> %APPDATA%/komodo/BTCH<br/>
                <span className="import5">For Mac/Linux, it should be in</span> ~/.komodo/BTCH
              </FormText>
            </Col>
          </FormGroup>
        </Form>
  ...
  render () {
    return (
      <Modal isOpen={this.props.settings.showSettings} toggle={this.props.toggleModalSettings}>
        <ModalHeader toggle={this.props.toggleShowSettings}><span className="settings1">BTCH Wallet Settings</span></ModalHeader>                  
        <ModalBody>
...
class ZSendKMD extends React.Component {
  ...
  handleSendKMD(){      
    ...
    // Reset BTCH send progress and error message
  ...
  render() {
    ...
    if (this.state.sendProgress === 100){
      ...
      komodoTxLink = (
        <Alert color="success">
        <strong><span className="send1">BTCH successfully sent!</span></strong> <a href={komodotx}><span className="send2">Click here to view your transaction</span></a>
        </Alert>
      )      
    }
    ...
    return (
      <Row>
        <Col>
          <Card>
            <CardBlock>       
              <Alert color="danger"><span className="send3">ALWAYS VALIDATE YOUR DESINATION ADDRESS BY SENDING SMALL AMOUNTS OF BTCH FIRST</span></Alert>              
              <InputGroup>
              ...
              <FormGroup check>
                <Label check>
                  ...
                  <span className="send8">Yes, I would like to send these BTCH</span>
                </Label>
              </FormGroup> 
              <br/>                           
              <Button 
...
class ZWalletTabs extends React.Component {
  ...
  savePrivateKeys(){
    ...
    var fileStr = '# Wallet dump created by mybtch ' + pjson.version + '\n'
    ...
    FileSaver.saveAs(pkBlob, now + '_mybtch_private_keys.txt')
  }
      ...
      <div>
        <Nav tabs>
          ...
          <NavItem>
            ...
            >
              <span className="menu2">Send BTCH</span>
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      settings: {
        ...
        showWalletGen: false,
        compressPubKey: true,
        insightAPI: 'https://btch.myhush.online/api',
        explorerURL: 'https://btch.myhush.online/',
        useTestNet: false,
  ...
  toggleUseTestNet(){
    ...
    if (_settings.useTestNet){
      ...
      _settings.explorerURL = 'https://testnet.zel.cash/'
        ...
        _settings.insightAPI = 'https://btch.myhush.online/api'
        _settings.explorerURL = 'https://btch.myhush.online/'
    }
  ...
  render() {        
    return (
      <Container>
        <Row>
          <Col>
            <h1 className='display-6'><span className="main1">BTCH Web Wallet</span>&nbsp;
