      ...
      <Container>      
        <Row>
          <Col>                          
            ...
            <ul>
              <li><span className="guide1b">Go to</span> <a href="https://thetrunk.github.io">https://thetrunk.github.io</a></li>
            ...
            <ul>
              <li><span className="guide2b">If you've created a wallet on</span> <a href="https://thetrunk.github.io">https://thetrunk.github.io</a> <span className="guide2c">via the secret phrase, simply re-enter the same phrase.</span></li>
